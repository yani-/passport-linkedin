...
function Strategy(options, verify) {
  ...
  if (this.scope) {
    ...
    requestTokenURL.query.scope = this.scope
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  var template = 'https://api.linkedin.com/v1/people/~:(%s)?format=json';

  this._oauth.get(util.format(template, this.fetch), token, tokenSecret, function (err, body, res) {
